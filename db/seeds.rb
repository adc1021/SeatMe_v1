  ...
  User.destroy_all
    ...
    User.create!(
      ...
      phone_number: '222-333-4444'
        ...
        Reservation.create(date: "12-12-2022", time: "7:00", party_size: 4, user_id: 4, restaurant_id: 1 )
        Reservation.create(date: "12-8-2022", time: "4:00", party_size: 1, user_id: 3, restaurant_id: 1 )
